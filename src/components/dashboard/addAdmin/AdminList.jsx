    ...
    <section className="bg-white p-4 rounded-lg shadow-md h-full">
      <div className="flex justify-between items-center mb-10 border-b border-tertiaryDark pb-3 -mx-6 px-6">
        <h2 className="flex gap-2 text-base font-bold">
          <img src={icon} alt="dashboard icon" /> Administrators List
        </h2>
        <div className="space-x-4 flex items-center">
            ...
            <tbody>
              {currentCourses.map((admin, index) => (
                <tr key={index} className="border-b border-tertiary font-normal text-xs">
                  ...
                  <td className="p-2 border-r-2 border-tertiary">{admin.phone}</td>
                  <td className="p-2 border-r-2 border-tertiary">{admin.email}</td>
                  <td className="p-2 border-r-2 border-tertiary">{admin.action}</td>
                </tr>
              ))}
            </tbody>
          </table>
