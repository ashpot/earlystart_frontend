...
import ManageCompetition from '../components/dashboard/addCompetition/ManageCompetition'

const ManageCompetitionPage = () => {
	...
	<div className="flex min-h-screen">
	  ...
	  <div className="flex-1 flex flex-col bg-[#EFEFEF]">
		...
		<div className="w-[95%] mx-auto py-7">
		  <h2 className="font-inter font-bold text-base py-4">ALL COMPETITIONS</h2>
		  <ManageCompetition />
		</div>
	  </div>
	</div>
