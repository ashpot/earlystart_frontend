...
import LessonTestForm from '../components/dashboard/addLessonTest/LessonTestForm';
import 'react-loading-skeleton/dist/skeleton.css';
import '../css/dashboardPage.css';

const AddLessonTestPage = () => {
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col bg-[#EFEFEF]">
        ...
        <div className="w-[95%] mx-auto py-7">
          <h2 className="font-inter font-bold text-base py-4">ADD LESSON TEST</h2>
          <LessonTestForm />
        </div>
      </div>
    </div>
...
export default AddLessonTestPage;