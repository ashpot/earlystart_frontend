...
import LessonTestList from '../components/dashboard/addLessonTest/LessonTestList'

const ManageLessonTest = () => {
	...
	<div className="flex min-h-screen">
	  ...
	  <div className="flex-1 flex flex-col bg-[#EFEFEF]">
		...
		<div className="w-[95%] mx-auto py-7">
		  <h2 className="font-inter font-bold text-base py-4">MANAGE LESSONS</h2>
		  <LessonTestList />
		</div>
	  </div>
	</div>
...
export default ManageLessonTest;
